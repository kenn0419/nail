    ...
    return (
        <div className='relative w-main mx-auto mt-[-50px]'>
            ...
            <div className='flex justify-evenly mt-5'>
                ...
                <div>
                    <div className={clsx('flex flex-col items-center w-[350px] p-5  rounded-2xl bg-sub-main gap-3', showContact ? 'h-[500px]' : 'h-[400px]')}>
                    ...
                    <div className='mt-10 bg-sub-main rounded-2xl p-5'>
