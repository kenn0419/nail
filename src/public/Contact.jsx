...
const Contact = () => {
    return (
        <div className='tablet:w-[100%] px-2 phone:w-[100%] mx-auto w-main flex flex-col items-center'>
            <h4 className='tablet:text-center px-2 phone:text-center'>If you have questions, comments, or other feedback related to our services, please contact us to discuss.</h4>
            <div className="tablet:flex-col px-2 phone:flex-col flex justify-center gap-20 my-5 w-[100%]">
                <div className='flex flex-col items-center gap-3'>
                    <h5 className='text-[35px] font-semibold'>Contact Details</h5>
                    <span className='text-center'>Hollywood nails & Beauty, 112 E Main St, Broxburn EH52 5EQ</span>
