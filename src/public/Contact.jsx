            ...
            <div className="flex justify-center gap-20 my-5 w-[100%]">
                <div className='flex flex-col items-center gap-3'>
                    ...
                    <div className='flex items-center gap-3'>
                        ...
                        <Link to={`https://www.instagram.com/hollywoodnailsinbroxburn/`}><img className='w-8 h-8' src={insta} alt="insta" /></Link>
                    </div>
                ...
                <div className='flex flex-col items-center gap-3'>
                    ...
                    <Link to={`https://www.google.com/maps/dir//112+E+Main+St,+Broxburn+EH52+5EQ,+V%C6%B0%C6%A1ng+qu%E1%BB%91c+Anh/@55.9342025,-3.550048,12z/data=!4m8!4m7!1m0!1m5!1m1!1s0x4887db4a36eafa61:0xcaff735c2ae41d80!2m2!1d-3.4676481!2d55.93423?entry=ttu&g_ep=EgoyMDI0MDkxNi4wIKXMDSoASAFQAw%3D%3D`} className='bg-button px-5 py-3 rounded-lg text-[#000] font-semibold uppercase'>Review US on Google</Link>
                </div>
            </div>
