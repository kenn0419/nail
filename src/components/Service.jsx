...
const Service = () => {
    ...
    return (
        <div className="bg-sub-main my-20 py-10 relative service flex flex-col items-center">
            ...
            <div className='w-main mx-auto flex items-center gap-20 mt-5'>
                ...
                <img src={service_banner} alt="service banner" className='rounded-lg hover:scale-110 cursor-pointer transition-all delay-300' />
            </div>
        </div>
    )
}
